    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Add Remarks</h3>
...
<section class="bg-coolGray-50 py-4">
    <div class="container px-4 mx-auto">
        <div class="pt-6 bg-white overflow-hidden border border-coolGray-100 rounded-md shadow-dashboard">
            <h2 class="px-6 mb-4 text-lg text-coolGray-900 font-semibold">Counselor Remarks</h2>
            <div class="px-6 overflow-x-auto">
                <table class="w-full">
                    <tr class="whitespace-nowrap h-11 bg-coolGray-50 bg-opacity-80">
                        ...
                        <th class="whitespace-nowrap px-4 font-semibold text-xs text-coolGray-500 uppercase text-center">Remark</th>
                        <th class="whitespace-nowrap px-4 font-semibold text-xs text-coolGray-500 uppercase text-center">Date and time</th>
                        <th><button class="flex flex-wrap justify-center w-full px-4 py-2 bg-blue-500 hover:bg-blue-600 font-medium text-sm text-white border border-blue-500 rounded-md shadow-button" type="button" data-modal-toggle="authentication-modal">Add Remark</button></th>
                    </tr>
                    ...
                    <?php if ($counselor_remarks) : ?>
                        <?php foreach ($counselor_remarks as $remark) : ?>
                            ...
                            <div id="edit_remark_<?php echo $remark->cid; ?>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    <!-- Modal content -->
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <form class="space-y-6" action="<?php echo base_url(); ?>student/record/delRec/" method="post">
                                            <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                                ...
                                                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                                    ...
                                                    <button type="button" data-modal-toggle="edit_remark_<?php echo $remark->cid; ?>" class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">Cancel</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <tr class="h-18 border-b border-coolGray-100">
                                ...
                                <th class="px-4 bg-white text-sm font-medium text-coolGray-800 text-center"><?php echo $remark->remark; ?></th>
                                ...
                                <th class="whitespace-nowrap px-4">
                                    <button class="flex flex-wrap justify-center w-full px-4 py-2 bg-red-500 hover:bg-red-600 font-medium text-sm text-white border border-red-500 rounded-md shadow-button" type="button" data-modal-toggle="edit_remark_<?php echo $remark->cid; ?>">Delete</button>
                                </th>
                            </tr>
                        <?php endforeach; ?>
                    <?php else : ?>
