        ...
        <div class="container px-4 mx-auto">
            <div class="flex flex-wrap justify-center text-center -mx-4">
                <div class="w-full md:w-1/3 lg:w-1/4 px-4 mb-8 lg:mb-0">
                    <h2 class="mb-2 text-4xl md:text-5xl font-bold text-blue-600 tracking-tighter">&lt;nil&gt;</h2>
                    <p class="text-lg md:text-xl text-coolGray-500 font-medium">Student Records Registereed</p>
                </div>
                <div class="w-full md:w-1/3 lg:w-1/4 px-4 mb-8 lg:mb-0">
