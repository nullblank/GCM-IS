            ...
            <div class="pb-6 border-b border-coolGray-100">
                <div class="flex flex-wrap items-center justify-between -m-2">
                    ...
                    <div class="w-full md:w-1/3 p-3">
                        <input type="text" placeholder="Search..." name="search" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-blue-500 border border-coolGray-200 rounded-lg shadow-input">
                        <p><?php echo form_error('search'); ?></p>
                    </div>
                    <div class="w-full md:w-1/6 p-3">
                        <select name="search" class="appearance-none w-full py-2.5 px-4 text-coolGray-900 text-base font-normal bg-white border outline-none border-coolGray-200 focus:border-green-500 rounded-lg shadow-input">
