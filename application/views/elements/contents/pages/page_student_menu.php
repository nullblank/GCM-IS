    ...
    <section class="py-24 bg-coolGray-900" style="background-image: url('<?php echo base_url(); ?><flex-ui-assets/elements/pattern-dark2.svg'); background-position: center;">
        <div class="container px-4 mx-auto">
            ...
            <div class="max-w-3xl mx-auto">
                ...
                <!-- Medical History -->
                <a class="group block mb-6" href="<?php echo base_url(); ?>student/Medical/med/<?php echo $stud_id; ?>">
                    <div class="flex items-center justify-between flex-wrap p-10 bg-coolGray-800 group-hover:bg-coolGray-700 rounded-md shadow-md transition duration-200">
                        <div class="w-full md:w-1/2 mb-2 md:mb-0">
                            <h3 class="text-lg md:text-xl text-white group-hover:text-coolGray-100 font-semibold">Medical History</h3>
                        </div>
                        <div class="w-full md:w-1/2 md:text-right">
                            <div class="inline-flex items-center leading-6 text-green-500 group-hover:text-green-600 font-medium transition duration-200">
                                <span class="mr-2">Answer Form</span>
                ...
                <a class="group block" href="#">
                    <div class="flex items-center justify-between flex-wrap p-10 bg-coolGray-800 group-hover:bg-coolGray-700 rounded-md shadow-md transition duration-200">
                        <div class="w-full md:w-1/2 mb-2 md:mb-0">
                            <h3 class="text-lg md:text-xl text-white group-hover:text-coolGray-100 font-semibold">Short Self Positive Behaviors Survey</h3>
                        </div>
                        <div class="w-full md:w-1/2 md:text-right">
                            <div class="inline-flex items-center leading-6 text-green-500 group-hover:text-green-600 font-medium transition duration-200">
                                <span class="mr-2">Answer Form</span>
