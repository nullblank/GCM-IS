                            ...
                            <form method="post" action="<?php echo base_url(); ?>student/record/chk_id">
                                <div class=" ml-6 flex flex-wrap mb-1">
                                    <div class="w-full md:flex-1 mb-3 md:mb-0 md:mr-6">
                                        <input required type="text" name="stud_id" placeholder="Enter your ID number" class="w-full py-3 px-4 text-coolGray-500 leading-tight placeholder-coolGray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 border border-coolGray-200 rounded-lg shadow-xsm">
                                    </div>
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full md:w-1/3 px-4 mb-12 md:mb-0">
                    <div class="max-w-xs mx-auto text-center">
                        <div class="inline-flex mb-6 items-center justify-center w-18 h-18 bg-blue-500 rounded-full">
                        ...
                        <a class="text-lg md:text-xl text-blue-500 hover:text-blue-600 font-medium" href="mailto:#">Something@someone.com</a>
                    </div>
                </div>
                <div class="w-full md:w-1/3 px-4 mb-12 md:mb-0">
                    <div class="max-w-xs mx-auto text-center">
                        ...
                        <p class="text-lg md:text-xl text-blue-500 font-medium">0000 000 0000</p>
                    </div>
                </div>
                <div class="w-full md:w-1/3 px-4">
                    <div class="max-w-xs mx-auto text-center">
                        ...
                        <p class="text-lg md:text-xl font-medium text-blue-500">Saint Mary's University</p>
                        <p class="text-lg md:text-xl font-medium text-blue-500">Administration Building</p>
                    </div>
                </div>
            </div>
        </div>
