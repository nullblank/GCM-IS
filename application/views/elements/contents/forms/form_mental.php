                            ...
                            <div class="w-full md:w-2/3 p-3">
                                <div class="relative">
                                    <svg class="absolute right-4 top-1/2 transform -translate-y-1/2" width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <option value="More or less a week ago">More or less a week ago</option>
                                        <option value="Between 3 and 6 months ago">Between 3 and 6 months ago</option>
                                        <option value="A month ago">A month ago</option>
                                        <option value="Between 6 months and 1 year ago">Between 6 months and 1 year ago</option>
                                        <option value="More than 2 years ago">More than 2 years ago</option>
                                        <option value="Between 1 and 3 months ago">Between 1 and 3 months ago</option>
                            ...
                            <div class="w-full md:w-2/3 p-3">
                                <div class="relative">
                                    <svg class="absolute right-4 top-1/2 transform -translate-y-1/2" width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <option value="11-20 times">11-20 times</option>
                                        <option value="21-50 times">21-50 times</option>
                                        <option value="More than 50 times">More than 50 times</option>
                                    </select>
                                </div>
                                <p><?php echo form_error('men_q1'); ?></p>
                            </div>
