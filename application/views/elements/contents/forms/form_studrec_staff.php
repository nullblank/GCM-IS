                ...
                <div class="w-full md:w-6/6">
                    <div class="flex flex-wrap -m-3">
                        ...
                        <div class="w-full md:w-1/6 p-3">
                            <a href="<?php echo base_url('DashboardStaff/StudentRecords');?>" data-modal-toggle="" class="flex flex-wrap justify-center w-full px-4 py-3 font-medium text-sm border border-red-500 rounded-md shadow-button">
                                Print
                            </a>
                        </div>
                        <div class="w-full md:w-1/6 p-3">
