        ...
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    <input value="<?php echo $student->stud_id; ?>" name="s_id" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
        ...
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    ...
                    <input value="1" name="s_first" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3">
    ...
    <div class="py-6 border-b border-coolGray-100">
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    <input value="<?php echo $student->s_gender; ?>" name="s_gender" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3"></div>
    ...
    <div class="py-6 border-b border-coolGray-100">
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    <input value="<?php echo $student->s_eth; ?>" readonly="readonly" name="s_eth" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3"></div>
    ...
    <div class="py-6 border-b border-coolGray-100">
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    <input value="<?php echo $student->s_rel; ?>" readonly="readonly" name="s_rel" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3"></div>
        ...
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    ...
                    <input value="<?php echo $student->s_marstat; ?>" readonly="readonly" name="s_marstat" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3">
                    <p class="text-sm text-coolGray-400 font-regular">Spouse's Name (If applicable)</p>
                    <input value="<?php echo $student->s_nspouse; ?>" readonly="readonly" name="s_nspouse" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="Not Applicable">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
        ...
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    ...
                    <input value="<?php echo $student->s_nchild; ?>" readonly="readonly" name="s_nochild" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="Not Applicable">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3"></div>
                <div class="w-full md:w-1/6 p-3"></div>
        ...
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    ...
                    <input value="<?php echo $student->s_brgy; ?>" readonly="readonly" name="s_brgy" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3">
                    <p class="text-sm text-coolGray-400 font-regular">Municipality</p>
                    <input value="<?php echo $student->s_muni; ?>" readonly="readonly" name="s_muni" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="Not Applicable">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
        ...
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    ...
                    <input value="<?php echo $student->s_provi; ?>" readonly="readonly" name="s_provi" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="Not Applicable">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3"></div>
    ...
    <div class="py-6 border-b border-coolGray-100">
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    <input value="<?php echo $student->s_nor; ?>" readonly="readonly" name="s_nor" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3"></div>
        ...
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    ...
                    <input value="<?php echo $student->s_guardn; ?>" readonly="readonly" name="s_guardn" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?> </p>
                </div>
                <div class="w-full md:w-2/6 p-3">
                    <p class="text-sm text-coolGray-400 font-regular">Contact Number</p>
                    <input value="<?php echo $student->s_guardno; ?>" readonly="readonly" name="s_guardno" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
        ...
        <div class="w-full md:w-6/6">
            <div class="flex flex-wrap -m-3">
                ...
                <div class="w-full md:w-2/6 p-3">
                    ...
                    <input value="<?php echo $student->s_guardadd; ?>" readonly="readonly" name="s_guardadd" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3">
                    <p class="text-sm text-coolGray-400 font-regular">Relationship with Guardian</p>
                    <input value="<?php echo $student->s_guardrel; ?>" readonly="readonly" name="s_guardrel" class="w-full px-4 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="First Name">
                    <p><?php echo form_error('s_first'); ?></p>
                </div>
                <div class="w-full md:w-2/6 p-3"></div>
                <div class="w-full md:w-1/6 p-3"></div>
