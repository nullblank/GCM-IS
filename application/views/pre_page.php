                    ...
                    <div class="flex justify-between items-center w-full">
                        ...
                        <div class="w-1/2 xl:w-1/3">
                            <div class="hidden xl:flex items-center justify-end">
                                <a class="inline-block py-2 px-4 mr-2 leading-5 text-coolGray-400 hover:text-coolGray-50 bg-transparent font-medium rounded-md" href="<?php echo base_url(); ?>login">Log In</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <nav class="relative p-6 h-full overflow-y-auto">
                            <div class="flex flex-col justify-between h-full">
                                <a class="inline-block" href="#">
                                    <img class="h-8" src="flex-ui-assets/logos/flex-ui-green.svg" alt="">
                                </a>
                                <ul class="py-6">
                                    <li><a class="block py-3 px-4 text-coolGray-400 hover:text-white font-medium hover:bg-coolGray-800 rounded-md" href="#">Product</a></li>
                                    <li><a class="block py-3 px-4 text-coolGray-400 hover:text-white font-medium hover:bg-coolGray-800 rounded-md" href="#">Features</a></li>
                                    <li><a class="block py-3 px-4 text-coolGray-400 hover:text-white font-medium hover:bg-coolGray-800 rounded-md" href="#">Pricing</a></li>
                                    <li><a class="block py-3 px-4 text-coolGray-400 hover:text-white font-medium hover:bg-coolGray-800 rounded-md" href="#">Resources</a></li>
                                </ul>
                    ...
                    <div class="flex flex-wrap xl:items-center -mx-4">
                        <div class="w-full md:w-1/2 px-4 mb-16 md:mb-0">
                            ...
                            <div class="ml-6 flex flex-wrap">
                                <div class="w-full md:w-3/6 p-0">
                                    <input class="h-12 w-full px-3.5 py-2.5 text-base text-coolGray-900 font-normal outline-none focus:border-green-500 border border-coolGray-200 rounded-lg shadow-input" type="text" placeholder="Enter your ID number.">
                                </div>
                                <div class="w-full md:w-auto py-1 md:py-0"><a class="inline-block py-4 px-6 w-full text-base md:text-lg leading-4 text-blue-100 font-medium text-center bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-700 focus:ring-opacity-50 rounded-md shadow-sm ml-2" type="submit">Submit</a></div>
                            </div>
                            </form>
                            <!-- end of form -->
                        </div>
                        <div class="w-full md:w-1/2 px-4">
                            <div class="relative mx-auto md:mr-0 max-w-max">
                                ...
                                <img class="relative rounded-7xl object-fill w-10/12" src="assets/images/placeholder.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="wave-bottom w-full text-coolGray-900">
                ...
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full md:w-1/3 px-4 mb-12 md:mb-0">
                        <div class="max-w-xs mx-auto text-center">
                            <div class="inline-flex mb-6 items-center justify-center w-18 h-18 bg-green-500 rounded-full">
                                <svg class="h-8 text-white" width="32" height="32" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h3 class="mb-2 text-2xl md:text-3xl leading-9 text-coolGray-900 font-bold">Email</h3>
                            <p class="mb-4 text-lg md:text-xl font-medium text-coolGray-500 leading-7">Concerns? Send us an Email!</p>
                            <a class="text-lg md:text-xl text-green-500 hover:text-green-600 font-medium" href="mailto:#">Something@someone.com</a>
                        </div>
                    </div>
                    <div class="w-full md:w-1/3 px-4 mb-12 md:mb-0">
                        <div class="max-w-xs mx-auto text-center">
                            ...
                            <p class="mb-4 text-lg md:text-xl font-medium text-coolGray-500 leading-7">Need to voice out? Call us!</p>
                            <p class="text-lg md:text-xl text-green-500 font-medium">0000 000 0000</p>
                        </div>
                    </div>
                    <div class="w-full md:w-1/3 px-4">
                        <div class="max-w-xs mx-auto text-center">
                            ...
                            <h3 class="mb-2 text-2xl md:text-3xl leading-9 text-coolGray-900 font-bold">Office</h3>
                            <p class="mb-4 text-xl font-medium text-coolGray-500 leading-7">How about pay us a visit?</p>
                            <p class="text-lg md:text-xl font-medium text-green-500">Saint Mary's University</p>
                            <p class="text-lg md:text-xl font-medium text-green-500">Administration Building</p>
                        </div>
                    </div>
                </div>
            </div>
